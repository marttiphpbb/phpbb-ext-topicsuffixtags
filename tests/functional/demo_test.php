...
namespace marttiphpbb\topicsuffixtags\tests\functional;

/**
* @group functional
*/
class topicsuffixtags_test extends \phpbb_functional_test_case
{
	static protected function setup_extensions()
	{
		return ['marttiphpbb/topicsuffixtags'];
	}
	...
	public function test_demo_acme()
	{
		...
		$this->add_lang_ext('marttiphpbb/topicsuffixtags', 'common');
