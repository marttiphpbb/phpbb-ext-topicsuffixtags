...
namespace marttiphpbb\topicsuffixtags\exception;
...
class base extends \Exception
{
	...
	* @return \marttiphpbb\topicsuffixtags\exception\base
	* @access public
	*/
	...
	*/
	public function add_lang(\phpbb\user $user)
	{
		...
		// Add our language file
		$user->add_lang_ext('marttiphpbb/topicsuffixtags', 'exceptions');
